  ...
  private static getPreferenceOrder(prefer?: AVHWDeviceType[]): AVHWDeviceType[] {
    ...
    if (platform === 'darwin') {
      ...
      if (isARM) {
        ...
        preferenceOrder = [AV_HWDEVICE_TYPE_CUDA, AV_HWDEVICE_TYPE_VAAPI, AV_HWDEVICE_TYPE_QSV, AV_HWDEVICE_TYPE_DRM, AV_HWDEVICE_TYPE_VULKAN, AV_HWDEVICE_TYPE_OPENCL];
      }
    }
